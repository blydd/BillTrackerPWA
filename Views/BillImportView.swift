        ...
        List {
            ...
            Section("文件格式要求") {
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    VStack(alignment: .leading, spacing: 4) {
                        ...
                        Text("3. 交易类型 (支出/收入/不计入)")
                        Text("4. 账单类型 (多个类型用 \"; \" 分隔)")
                        Text("5. 归属人")
                        Text("6. 支付方式")
                        Text("7. 备注 (可选)")
                    }
            ...
            Section("示例格式") {
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    Text("""
                    日期,金额,交易类型,账单类型,归属人,支付方式,备注
                    2024-01-15 12:30:00,-25.50,支出,食,张三,微信支付,午餐
                    2024-01-15 18:00:00,-35.00,支出,食; 娱乐,李四,支付宝,晚餐聚会
                    2024-01-16 09:00:00,5000.00,收入,工资,张三,银行卡,月薪
                    2024-01-17 10:00:00,-2000.00,不计入,还信用卡,张三,储蓄卡,还款
                    """)
